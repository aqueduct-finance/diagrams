...
export default function SwapWithFees() {
    return (
        <div className="flex items-center justify-center h-screen">
            <div className=''>
                <div className='translate-y-[7.25rem] space-y-2'>
                ...
                <div className='flex items-center justify-center space-x-4'>
                    <div className='flex items-center p-4 rounded-3xl border-2 border-black/60 text-black/80 space-x-2 translate-y-10'>
                        <RiUser3Line size={20} />
                        <p>Trader</p>
                    </div>

        ...
        <div className="flex items-center justify-center h-screen">
            <div className=''>
                <div className='translate-y-16 space-y-2'>
                    <div className='bg-aqBlue/10 text-aqBlue font-bold w-min px-4 py-1 rounded-full whitespace-nowrap'>
                        PROVIDE LIQUIDITY
                    </div>
                ...
                <div className='flex items-center justify-center space-x-4'>
                    ...
                    <div className='flex flex-col items-center translate-y-8'>
                        ...
                        <div className='h-2' />
                        <div className='flex flex-col items-center'>
                            <p className='text-sm pb-1 text-tokenB/80 font-bold'>
                                200 token B / s
                            </p>
                            <div className='flex items-center justify-end w-64 h-[0.18rem] bg-tokenB/80 rounded-full'>

import { IMetricChartData, IMetricMappedDataPoint, IMetricOppositeLine } from '../types/metric';
...
export function mapDataToSvgCoordinates(dataPoints: IMetricChartData): IMetricMappedDataPoint[] {
